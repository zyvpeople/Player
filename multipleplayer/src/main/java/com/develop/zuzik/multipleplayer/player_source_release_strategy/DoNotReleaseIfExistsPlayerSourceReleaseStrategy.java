 ...
 * Date: 8/27/16
 */
public class DoNotReleaseIfExistsPlayerSourceReleaseStrategy<SourceInfo> implements PlayerSourceReleaseStrategy<SourceInfo> {
	@Override
	public boolean releaseCurrentPlayback(List<PlayerSource<SourceInfo>> newPlayerSources, PlayerSource<SourceInfo> currentPlayerSource) {
		return !newPlayerSources.contains(currentPlayerSource);
	}
}
