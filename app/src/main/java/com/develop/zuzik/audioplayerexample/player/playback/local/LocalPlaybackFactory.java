...
public class LocalPlaybackFactory<SourceInfo> implements PlaybackFactory<SourceInfo> {
	@Override
	public Playback<SourceInfo> create(Context context, PlaybackSettings settings, PlayerSource<SourceInfo> playerSource) {
		return new LocalPlayback<>(context, settings, playerSource);
	}
}
